//Generated:2023-04-21 18:03:15// 39-537
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6886820 || '',
    GUID: window.ftGUID_6886820 || '99999999999',
    confID: window.ftConfID_6886820 || '0',
    ftReturn: window.ftReturn_6886820 || '',
    keyword: window.ftKeyword_6886820 || '',
    ftId: window.ftId_6886820 || '',
    imp: window.ftImp6886820,
    ftImpId: window.ftImp6886820 && window.ftImp6886820.impID || '',
    gdpr: window.ftImp6886820 && window.ftImp6886820.gdpr || '',
    gdpr_consent: window.ftImp6886820 && window.ftImp6886820.gdpr_consent || '',
    gdpr_pd: window.ftImp6886820 && window.ftImp6886820.gdpr_pd || '',
    us_privacy: window.ftImp6886820 && window.ftImp6886820.us_privacy || '',
    campaignID: '195298',
    cID: '157924',
    pID: '6886820',
    creativeID: '4271639',
    ...
    clickTags: [
      "https://servedby.flashtalking.com/click/8/195298;6886820;4271639;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://business.comcast.com/business-bundles?CMP=BAC-[EBUY]-[ESID]-[EPID]-[ECID]&omndfa=1&dclid=[%FT_RANDOM%]-[EADV]-[EBUY]-[EPID]-[EAID]-[ERID]&DIV=West-195298-6886820-4271639"
    ],
    placementDescription: 'BUSQ12023B2BWSTTOTDT6886820FT728x90',
    width: 728,
    height: 90,
    ...
    divID: 'ftdiv6886820',
    phID: 'ftpos6886820',
    frameID: 'ftframe6886820',
    expID: 'ftexpframe6886820',
    altImgID: 'ftalt6886820',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'https://servedby.flashtalking.com/click/8/195298;6886820;4271639;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://business.comcast.com/business-bundles?CMP=BAC-[EBUY]-[ESID]-[EPID]-[ECID]&omndfa=1&dclid=[%FT_RANDOM%]-[EADV]-[EBUY]-[EPID]-[EAID]-[ERID]&DIV=West-195298-6886820-4271639',
    altImg: 'https://servedby.flashtalking.com/imp/8/195298;6886820;204;gif;XfinityUS;BUSQ12023B2BWSTTOTDT6886820FT728x90/?',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/195298;6886820;271;pixel;XfinityUS;BUSQ12023B2BWSTTOTDT6886820FT728x90/?',
    stump: 'https://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/688/6886820/4271639/js/j-6886820-4271639.js',
    file: 'http://cdn.flashtalking.com/157924/4271639/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?225636214-6886820;4271639;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: false,
    segment: window.ftSegment_6886820 || '',
    segmentList: window.ftSegmentList_6886820 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6886820 && window.ftImp6886820.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6886820') && /^https:/.test(document.getElementById('ftscript_m6886820').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6886820'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6886820'],
      ['ftcfid', 'ftConfID_6886820'],
      ['fttime', 'ftTimestamp_6886820'],
      ['ftsection', 'ftSection_6886820'],
      ['ftcustom', 'ftCustom_6886820'],
      ['ft_id', 'ftId_6886820'],
      ['ftimpid', 'ftImp6886820', 'impID'],
      ['gdpr', 'ftImp6886820', 'gdpr'],
      ['gdpr_consent', 'ftImp6886820', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6886820', 'gdpr_pd'],
      ['us_privacy', 'ftImp6886820', 'us_privacy']
    ]
  };
...
ft6886820.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_6886820 !== "") ? window.ftSegment_6886820.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
...
(function(o) {
  ...
  var comcastContentVal = o.replaceMacros('[ftqs:[ftscw]]',true);
  var arr = comcastContentVal.split("%3B"), ccArray = [];

  for(var i in arr){
    if(arr[i] != ''){
      ccArray.push((arr[i]).split("3D")[1]);
    }
  }
  o.replaceMacros = function(str, cb) {
    var map = {
        CONTENT: comcastContentVal,
        SECTION: window['ftSection_' + o.pID],
        CUSTOM: window['ftCustom_' + o.pID],
        EBUY: window.ebuy || ccArray[0],
        ESID: window.esid || ccArray[1],
        EPID: window.epid || ccArray[2],
        ECID: window.ecid || ccArray[3],
        EADV: window.eadv || ccArray[4],
        EAID: window.eaid || ccArray[5],
        ERID: window.erid || ccArray[6],
        EEXCID: window.eexcid || ccArray[7],
        EEXPID: window.eexpid || ccArray[8],
        ERV: window.erv || ccArray[9],
        EIID: window.eiid || ccArray[10]
    },
...
(function(o) {
    ...
    var parallelClick = window.ftClick_6886820,
        dummyURL = "https://www.xfinity.com/";

    if(parallelClick && parallelClick.indexOf("eb2.3lift.com") == -1){
      parallelClick = o.decode(parallelClick);
    }

    //onpage
    o.addEventListener("clickthrough",function() {
    ...
    o.addEventListener("backup",function() {
      ...
      try{
        document.getElementById("ftdiv"+o.pID).onclick = fireOnClick; 
      } catch(err){

      }
    });

    o.addVClick = function(ct) {
        var pubClick = o.decode(o.qs('click', ''));
        var encodeCount = o.encodeClickCount;
        var escapeMod = "";
